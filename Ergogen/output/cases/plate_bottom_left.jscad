function board_left_l_extrude_5_outline_fn(){
...
.extrude({ offset: [0, 0, 5] });
                ...
                function plate_bottom_left_case_fn() {
                    

                // creating part 0 of case plate_bottom_left
                let plate_bottom_left__part_0 = board_left_l_extrude_5_outline_fn();

                // make sure that rotations are relative
                let plate_bottom_left__part_0_bounds = plate_bottom_left__part_0.getBounds();
                let plate_bottom_left__part_0_x = plate_bottom_left__part_0_bounds[0].x + (plate_bottom_left__part_0_bounds[1].x - plate_bottom_left__part_0_bounds[0].x) / 2
                let plate_bottom_left__part_0_y = plate_bottom_left__part_0_bounds[0].y + (plate_bottom_left__part_0_bounds[1].y - plate_bottom_left__part_0_bounds[0].y) / 2
                plate_bottom_left__part_0 = translate([-plate_bottom_left__part_0_x, -plate_bottom_left__part_0_y, 0], plate_bottom_left__part_0);
                plate_bottom_left__part_0 = rotate([0,0,0], plate_bottom_left__part_0);
                plate_bottom_left__part_0 = translate([plate_bottom_left__part_0_x, plate_bottom_left__part_0_y, 0], plate_bottom_left__part_0);

                plate_bottom_left__part_0 = translate([0,0,0], plate_bottom_left__part_0);
                let result = plate_bottom_left__part_0;
            ...
            function main() {
                return plate_bottom_left_case_fn();
            }
