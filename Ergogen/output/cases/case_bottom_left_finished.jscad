...
.extrude({ offset: [0, 0, 14.4] });
        ...
        function plate_bottom_left_screw_part_extrude_2_4_outline_fn(){
...
.union(
    ...
    CAG.circle({"center":[9,10.5],"radius":0.9})
                ...
                function plate_bottom_left_screw_part_case_fn() {


                // creating part 0 of case plate_bottom_left_screw_part
                let plate_bottom_left_screw_part__part_0 = plate_bottom_left_screw_part_extrude_2_4_outline_fn();

                // make sure that rotations are relative
                let plate_bottom_left_screw_part__part_0_bounds = plate_bottom_left_screw_part__part_0.getBounds();
                let plate_bottom_left_screw_part__part_0_x = plate_bottom_left_screw_part__part_0_bounds[0].x + (plate_bottom_left_screw_part__part_0_bounds[1].x - plate_bottom_left_screw_part__part_0_bounds[0].x) / 2
                let plate_bottom_left_screw_part__part_0_y = plate_bottom_left_screw_part__part_0_bounds[0].y + (plate_bottom_left_screw_part__part_0_bounds[1].y - plate_bottom_left_screw_part__part_0_bounds[0].y) / 2
                plate_bottom_left_screw_part__part_0 = translate([-plate_bottom_left_screw_part__part_0_x, -plate_bottom_left_screw_part__part_0_y, 0], plate_bottom_left_screw_part__part_0);
                plate_bottom_left_screw_part__part_0 = rotate([0,0,0], plate_bottom_left_screw_part__part_0);
                plate_bottom_left_screw_part__part_0 = translate([plate_bottom_left_screw_part__part_0_x, plate_bottom_left_screw_part__part_0_y, 0], plate_bottom_left_screw_part__part_0);

                plate_bottom_left_screw_part__part_0 = translate([0,0,0], plate_bottom_left_screw_part__part_0);
                let result = plate_bottom_left_screw_part__part_0;
...
.union(
    ...
    CAG.circle({"center":[9,10.5],"radius":2})
            ...
            function main() {
                let standoffs = translate([0,0,4], standoffs_bottom_left_case_fn());
                let standoffs_thumbs = translate([0,0,4], standoffs_bottom_thumbs_case_fn());
                let plate_top = translate([0,0,1.6], plate_bottom_left_screw_part_case_fn());
                let plate_bottom = plate_bottom_left_screw_head_part_case_fn();

                return union (standoffs, standoffs_thumbs, plate_top, plate_bottom);
            }
